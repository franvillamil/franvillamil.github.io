...
* **Generational legacies of authoritarianism: Evidence from Spain** (with Laia Balcells). *European Journal of Political Research*, forthcoming.
<br/><a href="./" target="_blank"><button type="button button1">PDF</button></a> <a href="./pubs/2026_balcells_villamil.html"><button type="button button1">details</button></a>
